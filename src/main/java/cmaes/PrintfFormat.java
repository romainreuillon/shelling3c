 ...
 *<ol>
 *<li>is not escaped public by a matching % or is
...
public PrintfFormat(Locale locale,String fmtArg)
   ...
   */
  public String nonControl(String s,int start) {
...
public String sprintf(double x)
   ...
   * provided that this percent sign
   *<ol>
   *<li>is not escaped public by a matching % or
  ...
  public class ConversionSpecification {
     ...
     * with trailing 0s.
     */
    public char[] fFormatDigits(double x) {
      // int defaultDigits=6;
      String sx;
      int i,j,k;
      int n1In,n2In;
	 ...
	 */
    public String fFormatString(double x) {
      char[] ca6,ca7;
     ...
     * double.
     */
    public char[] eFormatDigits(double x,char eChar) {
      char[] ca1,ca2,ca3;
      // int defaultDigits=6;
      String sx;
      int i,j,k,p;
     ...
     */
    public boolean checkForCarry(char[] ca1,int icarry) {
      boolean carry=false;
     ...
     *     more
     */
    public boolean startSymbolicCarry(
	 ...
	 * @return the converted double value.
	 */
    public String eFormatString(double x,char eChar) {
      char[] ca4,ca5;
      if (Double.isInfinite(x)) {
        if (x==Double.POSITIVE_INFINITY) {
     ...
     * @return the formatted String.
     */
    public String printFFormat(double x) {
     ...
     * @return the formatted String.
     */
    public String printEFormat(double x) {
     ...
     * @return the formatted String.
     */
    public String printGFormat(double x) {
      String sx,sy,sz,ret;
     ...
     * @return the formatted String.
     */
    public String printDFormat(short x) {
     ...
     * @return the formatted String.
     */
    public String printDFormat(long x) {
     ...
     * @return the formatted String.
     */
    public String printDFormat(int x) {
     ...
     * @return the formatted String.
     */
    public String printDFormat(String sx) {
      int nLeadingZeros=0;
      int nBlanks=0,n=0;
      int i=0,jFirst=0;
     ...
     * @return the formatted String.
     */
    public String printXFormat(short x) {
      String sx=null;
     ...
     * @return the formatted String.
     */
    public String printXFormat(long x) {
      String sx=null;
      if (x == Long.MIN_VALUE)
        sx = "8000000000000000";
      else if (x < 0) {
     ...
     * @return the formatted String.
     */
    public String printXFormat(int x) {
      String sx=null;
     ...
     * @return the formatted String.
     */
    public String printXFormat(String sx) {
      int nLeadingZeros = 0;
      int nBlanks = 0;
      if (sx.equals("0")&&precisionSet&&precision==0)
        sx="";
     ...
     * @return the formatted String.
     */
    public String printOFormat(short x) {
      String sx=null;
      if (x == Short.MIN_VALUE)
        sx = "100000";
      else if (x < 0) {
     ...
     * @return the formatted String.
     */
    public String printOFormat(long x) {
      String sx=null;
      if (x == Long.MIN_VALUE)
     ...
     * @return the formatted String.
     */
    public String printOFormat(int x) {
      String sx=null;
      if (x == Integer.MIN_VALUE)
        sx = "20000000000";
      else if (x < 0) {
     ...
     * @return the formatted String.
     */
    public String printOFormat(String sx) {
      int nLeadingZeros = 0;
      int nBlanks = 0;
      if (sx.equals("0")&&precisionSet&&precision==0)
        sx="";
     ...
     * @return the formatted String.
     */
    public String printCFormat(char x) {
      int nPrint = 1;
     ...
     * @return the formatted String.
     */
    public String printSFormat(String x) {
      int nPrint = x.length();
      int width = fieldWidth;
     ...
     */
    public boolean setConversionCharacter() {
      /* idfgGoxXeEcs */
      boolean ret = false;
     ...
     * Store the digits <code>n</code> in *n$ forms.
     */
    public boolean setFieldWidthArgPosition() {
      boolean ret=false;
      int xPos;
      for (xPos=pos; xPos<fmt.length(); xPos++) {
        if (!Character.isDigit(fmt.charAt(xPos)))
     ...
     * Store the digits <code>n</code> in *n$ forms.
     */
    public boolean setPrecisionArgPosition() {
      boolean ret=false;
      int xPos;
      for (xPos=pos; xPos<fmt.length(); xPos++) {
        if (!Character.isDigit(fmt.charAt(xPos)))
     ...
     */
    public boolean thousands = false;
    /**
     ...
     */
    public boolean leadingSign = false;
    /**
     * Flag indicating that left padding with spaces is
     * specified.
     */
    public boolean leadingSpace = false;
    /**
     ...
     * from the result.
     */
    public boolean alternateForm = false;
    /**
     * Flag indicating that left padding with zeroes is
     * specified.
     */
    public boolean leadingZeros = false;
    /**
     * Flag indicating that the field width is *.
     */
    public boolean variableFieldWidth = false;
    /**
     ...
     * has been set.
     */
    public boolean fieldWidthSet = false;
    /**
    ...
    /** Default precision. */
    public final static int defaultDigits=6; 
    /**
     * Flag indicating that the precision is *.
     */
    public boolean variablePrecision = false;
    /**
     * Flag indicating whether or not the precision has
     * been set.
     */
    public boolean precisionSet = false;
    /*
     */
    public boolean positionalSpecification=false;
    public int argumentPosition=0;
    public boolean positionalFieldWidth=false;
    public int argumentPositionForFieldWidth=0;
    public boolean positionalPrecision=false;
    public int argumentPositionForPrecision=0;
    /**
     * Flag specifying that a following d, i, o, u, x,
     * or X conversion character applies to a type
     * short int.
     */
    public boolean optionalh = false;
    /**
     * Flag specifying that a following d, i, o, u, x,
     * or X conversion character applies to a type lont
     * int argument.
     */
    public boolean optionall = false;
    /**
    ...
    public boolean optionalL = false;
    /** Control string type. */
    public char conversionCharacter = '\0';
    /**
  ...
  @SuppressWarnings("rawtypes")
public Vector vFmt = new Vector();
  /** Character position.  Used by the constructor. */
  public int cPos=0;
  /** Character position.  Used by the constructor. */
  public DecimalFormatSymbols dfs=null;
}
