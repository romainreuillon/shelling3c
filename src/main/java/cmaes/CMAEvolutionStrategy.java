...
/* 
 ...
 WISH LIST:
     ...
     o check Java random number generator and/or implement a public one. 
...
public class CMAEvolutionStrategy implements java.io.Serializable {
	 ...
	 * 
	 */
	public static final long serialVersionUID = 2918241407634253526L;
    ...
    public CMAParameters sp = new CMAParameters(); // alias for inside use
    ...
    public FitnessCollector fit = new FitnessCollector();
    ...
    public double[] getArrayOf(double x, int dim) {
     ...
     */
    public double[] expandToDimension(double[] x, int dim) {
    	if (x == null)
    		return null;
    	if (x.length == dim)
    		return x;
...
//    public void infoVerbose(String s) {
...
//    }
    ...
    public void error(String s) { // somehow a relict from the C history of this code
    ...
    class MyMath { // implements java.io.Serializable {
         ...
         * @param ar double[] 
         * @param maxidx last index to be considered */
        public int minidx(IntDouble[] ar, int maxidx) {
            int i, idx;
            idx = 0;
            for (i = 1; i < maxidx; ++i) {
    ...
    */
    ...
    public void tred2 (int n, double V[][], double d[], double e[]) {
    ...
    public void tql2 (int n, double d[], double e[], double V[][]) {
...
//    public IntDouble[] computePenalties() {
//    	int i, j, iNk;
...
/** search space dimensions must be set before the optimization is started. */
    ...
    public String[] fileswritten = new String[]{""}; // also (re-)initialized in init()
